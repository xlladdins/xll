...
[CREATE](CREATE.md).OBJECT   Creates an object

[FORMAT](FORMAT.md).SIZE   Sizes an object

[WINDOW](WINDOW.md).MOVE   Moves a window
...
[WINDOW.MOVE](WINDOW.MOVE.md)   Moves a wiFORMAT.MOVE
