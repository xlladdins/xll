...
[APPLY.STYLE   Applies](APPLY.STYLE   Applies.md) a style to the selection

[DELETE.STYLE   Deletes](DELETE.STYLE   Deletes.md) a cell style

[MERGE.STYLES   Imports](MERGE.STYLES   Imports.md) styles from another workbook into the active
...
[DEFINE](DEFINE.md).STYLE Syntaxes 2-7

[APPLY](APPLY.md).STYLE   Applies a style to the selection

[DELETE](DELETE.md).STYLE   Deletes a cell style

[MERGE](MERGE.md).STYLES   Imports styles from another workbook into the active
workbook
...
[CELL.PROTECTION](CELL.PROTECTION.md)   Allows you to control cell protection and display

[DELETE.STYLE](DELETE.STYLE.md)   Deletes a cell style

[FONT.PROPERTIES](FONT.PROPERTIES.md)   Applies a font to the selection

[FORMAT.NUMBER](FORMAT.NUMBER.md)   Formats numbers, dates, and times in the selected cells
